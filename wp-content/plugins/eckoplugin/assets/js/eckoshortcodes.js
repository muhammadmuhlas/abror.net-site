	...
	tinymce.PluginManager.add('eckoshortcodes_options', function(editor, url){
		editor.addButton('eckoshortcodes_button', {
			...
			menu: [
					...
					menu: [
						{
							...
							onclick: function(){
								editor.windowManager.open({
									...
									onsubmit: function(e){
										editor.insertContent('<pre><code data-language="' + e.data.codehighlight_language + '">USE "TEXT" POST EDITOR & INSERT CODE HERE</code></pre>');
									}
								});
							}
						},
				...
				{
					text: 'Theme Shortcodes',
					classes: 'theme-specific theme-onyx',
					menu: [
						{
							text: 'Contrast Block',
							onclick: function(){
