			...
			?>
				<section class="widget authorprofile">
					<div class="info" itemprop="author" itemscope="" itemtype="http://schema.org/Person">
						...
						<div class="profile gravatar"><img src="https://0.gravatar.com/avatar/<?php echo esc_attr(md5(get_the_author_meta('user_email'))); ?>?s=80" itemprop="image" alt="<?php esc_attr(the_author()); ?>" ></div>
						<?php }else{ ?>
						<a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'))); ?>" class="profile gravatar"><img src="https://0.gravatar.com/avatar/<?php echo esc_attr(md5(get_the_author_meta('user_email'))); ?>?s=80" itemprop="image" alt="<?php esc_attr(the_author()); ?>" ></a>
						<?php } ?>
						<div class="meta">
							<span class="title"><?php esc_html_e('Author', 'eckoplugin'); ?></span>
							<h3 itemprop="name">
								<?php if(isset($instance['disable_author_url'])){ ?>
					...
					<ul class="authorsocial">
						<?php if(get_the_author_meta('user_url', $post->post_author) != ''){ ?>
							<li><a href="<?php echo esc_url(get_the_author_meta('user_url', $post->post_author)); ?>" target="_blank" title="<?php echo esc_attr(get_the_author_meta('user_url', $post->post_author)); ?>" class="socialdark github"><i class="fa fa-link"></i></a></li>
						<?php } ?>
